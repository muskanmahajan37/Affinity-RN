...
class AssistanceSection extends Component {
    constructor(props) {
        super(props);
        this.state = {
        ...
        return (
            <View style={{ marginTop: 15 }}>
                ...
                <View style={styles.rowBox}>
                    ...
                    <Text style={[styles.commonText, {marginLeft: 40}]}> Caregiver/Contractor (CNA/HHA/Companion/Homemaker) is NOT ALLOWED to touch or administer pills or medication, including non-prescription drugs. </Text>
                </View>
            </View>
        )
    }
